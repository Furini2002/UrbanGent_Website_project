...
<head>
    ...
    <title>Cadastro de grupo de usuarios</title>
...
<body>
    <div class="container">    
        ...
        <div class="card-body">
            <div class="row">
            <h2 class="card-title col">Cadastrar grupo de Usuários</h2>
            <a href="listargusuario.php" class="card-title btn btn-primary col col-1" style="margin-right: 12px">
            ...
            <div class="card-body">      
                ...
                <form method="post">
                    ...
                    <div style="margin-top: 12px">
                        ...
                        <button name="cancelar" type="reset" class="btn btn-danger">Cancelar</button>
                    </div>
