...
if (isset($_POST['cadastrar'])) {
    ...
    $sql = "insert into produto (nome, unidademedida)
...
<body>
    <div class="container">    
        ...
        <div class="card-body">
            <div class="row">
            <h2 class="card-title col">Cadastrar produto</h2>
            <a href="listarproduto.php" class="card-title btn btn-primary col col-1" style="margin-right: 12px">
                ...
                <form method="post">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input name="nome" type="text" class="form-control" id="nome" placeholder="Insira aqui o nome do produto, caracteristicas e a marca">
                        </div>

                        <div class="col col-lg-3">
                            <label for="unidademedida" class="form-label">Unidade de medida</label>
                            <input name="unidademedida" type="text" class="form-control" id="unidademedida" placeholder="Insira aqui a unidade de medida">
                        </div>
                    </div>  
