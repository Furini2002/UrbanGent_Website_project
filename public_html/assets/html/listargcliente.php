...
if (isset($_GET['id'])) {//verifica se foi clicado o botão excluir
  $sql = "delete from grupocliente where id = " . $_GET['id'];
...
<body>
  ...
  <div class="container">
    ...
    <div class="card">
      <div class="card-body">
      <div class="row">
          <h2 class="card-title col">Grupo de clientes</h2>
          <a href="listarcliente.php" class="card-title btn btn-primary col col-1" style="margin-right: 12px">
            <i class="fa-solid fa-arrow-left" style="color: #000000; align-items: center; justify-content: center"></i>
          </a>
          <a href="cadastrargcliente.php" class="card-title btn btn-primary col-1" style="margin-right: 12px">
    ...
    <div>
      ...
      <table class="table table-striped">
        ...
        <tr>
          ...
          <a href="listargcliente.php?id=<?= $linha['id'] ?>" class="btn btn-danger"
