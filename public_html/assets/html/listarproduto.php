...
<body>
  ...
  <div class="container">
    ...
    <div class="card">
      <div class="card-body">
      <div class="row">
          <h2 class="card-title col">Produtos</h2>
          <a href= "cadastrarproduto.php" class="card-title btn btn-primary col-1" style="margin-right: 12px">
